/*
 * route_tree_timing_types.h
 *
 *  Created on: 5 Aug 2015
 *      Author: chinhau5
 */

#ifndef ROUTE_TREE_TIMING_TYPES_H
#define ROUTE_TREE_TIMING_TYPES_H
...
#endif /* VPR_SRC_ROUTE_ROUTE_TREE_TIMING_TYPES_H_ */

...
void clip(box &bb, const std::pair<int, int> &max);

void expand(box &b, const std::pair<int, int> &xexpand, const std::pair<int, int> &yexpand);

void make_l_segment(const point &source, const point &sink, bool xfirst, const std::pair<int, int> &xexpand, const std::pair<int, int> &yexpand, const std::pair<int, int> &max, bool clip, std::vector<box> &boxes);
